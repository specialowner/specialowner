...
const translations = {
  en: {
    ...
    viewProof: "View file",
    proof_pending_review: "Pending review",
    proof_approved: "Verified",
    proof_rejected: "Rejected — please re-upload",
    proofTooLarge: "File is too large. Please upload a file under 5MB.",
  ...
  ar: {
    ...
    viewProof: "عرض الملف",
    proof_pending_review: "قيد المراجعة",
    proof_approved: "تم التحقق",
    proof_rejected: "مرفوض — يرجى إعادة الرفع",
    proofTooLarge: "حجم الملف كبير جدًا. يرجى رفع ملف أقل من 5 ميجا.",
